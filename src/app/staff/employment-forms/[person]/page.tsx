  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
        Latest employment PDFs for {person.name} ({formatPersonEmails(person)}).
        Every admin can open these, including Natalie signing in with either
        work or Gmail. Drop files into{" "}
